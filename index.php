						...
						<div class="row align-items-center">
				            <div class="col-lg-7 col-md-7 order-1 order-md-2">
				                <div class="title-headingbg mt-1 ms-lg-5">
				                    <h3 class="headingbg mb-3 text-white"><?php echo $headertitle?></h3>
							...
							<form class="login-form" method="post" name="login_form" id="login-form">
								<div class="row">
									...
									<div class="col-lg-12 mb-0">
                                        ...
                                        <a href="http://noah-imports.trustechsol.co/login" class="btn btn-primary rounded w-100">Sign In</a>
									</div>
									<br><br>
									<div class="col-12 text-center">
										<p class="mb-0 mt-3"><small
												class="text-dark mr-2">You do not have an account?</small> <a
												href="https://www.noahimports.com/user/signup/"
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7 order-1 order-md-2">
                <div class="title-heading mt-2 ms-lg-5">
                    <h3 class="heading mb-3"><?php echo $uhtitle1;?> <br> <span class="text-danger"><strong><?php echo $uhtitle2;?></strong></span></h3>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            ...
                            <p class="text-muted mx-auto para-desc">Start working with <span class="text-primary fw-bold">Landrick</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                          ...
                          while($row = $result->fetch_assoc()) {
                            ...
                            <div class="tiny-slide">
                                <div class="d-flex client-testi m-2">
                                    <img src="uploads/<?php echo $row['image'];?>" class="avatar avatar-small client-image rounded shadow" alt="">
                                    <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                        ...
                                        <p class="text-muted mt-2">"<?php echo $row['review'];?>"</p>
                                        <h6 class="text-primary">- <?php echo $row['name'];?></h6>
                                    </div>
                                </div>
                            </div>
                            <?php
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="text-align: center; font-weight: 900; color: #4C1B8E;">
                ...
                <p style="color: gray">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7 order-2 order-md-1">
                <div class="title-headingbg mt-2 ms-lg-5">
                    <h3 class="headingbg mb-3"><?php echo $lbstitle1;?> <br><span class="heading text-warning"><strong><?php echo $lbstitle2;?></strong></span></h3>
