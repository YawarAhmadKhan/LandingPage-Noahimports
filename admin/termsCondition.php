...
<body class="bg-dark text-light">
    ...
    <?php include "include/sidebar.php";?>
        <div id="body" class="active">
            ...
            <h1 style="text-align: center; margin-top:20px">Terms & Conditions CMS</h1>
                ...
                <div class="container">
                    ...
                    <img src="../uploads/footer.JPG" alt="" style="margin-bottom: 20px;"> -->
                        ...
                        <?php
                            ...
                            ?>
                        <div class="col-md-12">
                        <form action="backend/termsUpdate.php" method="POST">
                        <div class="form-group">
                            <label for="">Terms And Conditions</label>
                           <textarea name="data" id="" cols="30" rows="30" class="form-control"><?php echo $data?></textarea>
                        </div> <br>
                        <input type="submit" name="submit" class="btn btn-success" value="Update Terms & Conditions">
